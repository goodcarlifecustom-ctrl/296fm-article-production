...
test('H3 navigation is generated only for configured H2 IDs', () => {
  ...
  try {
    const html = '<h2 id="without-list">一覧なし</h2><p>導入です。</p><h3 id="a">A</h3><p>A本文です。</p><h3 id="b">B</h3><p>B本文です。</p><h3 id="c">C</h3><p>C本文です。</p><h2 id="with-list">一覧あり</h2><p>導入です。</p><h3 id="d">D</h3><p>D本文です。</p>';
...
test('decoration splits a long plain paragraph without changing its text', () => {
  ...
  try {
    ...
    writeFileSync(`articles/${slug}/decoration.json`, JSON.stringify({ version: 2, enabled: true, outline: { enabled: true, title: '【この記事でわかること】' }, markers: [], paragraph_splits: [{ section: { level: 2, heading: '長文の確認' }, paragraph_index: 0, after: [first] }] }));
    rmSync(`articles/${slug}/article-linked.html`, { force: true });
